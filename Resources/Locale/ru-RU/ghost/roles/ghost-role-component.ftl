...
ghost-role-information-lost-challenge-cargo-technican-rules = Вы не враждебны к станции и делаете то, что должны, чтобы обеспечить собственное выживание.
                                     Вы не помните ничего из своей предыдущей жизни и не помните ничего из того, что узнали, будучи призраком.
                                     Вам разрешено помнить знания об игре в целом, например, как готовить, как использовать предметы и т.д.
                                     Вам [color=red]НЕ[/color] разрешается помнить или говорить имя, внешность и т.д. вашего предыдущего персонажа.
...
ghost-role-information-mothership-core-desc = Вы — ядро Материнского корабля ксеноборгов. Помогайте им размножаться, вживляя любой мозг, который они вам принесут, в тело киборга
ghost-role-information-xenoborg-name = Ксеноборг
ghost-role-information-xenoborg-desc = Странный киборг, созданный для саморепликации и захвата станции путём превращения любых разумных существ в ксеноборгов.
