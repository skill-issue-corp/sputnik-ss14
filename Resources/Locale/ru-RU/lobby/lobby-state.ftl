...
lobby-state-background-text = Фоновое изображение: [color=white]{$backgroundTitle}[/color] by [color=white]{$backgroundArtist}[/color]
lobby-state-background-no-background-text = Фоновое изображение не загружено.
