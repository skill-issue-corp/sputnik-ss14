...
signal-port-description-logic-memory-input = Сигнал для записи в ячейку памяти, при активном разрешении.

signal-port-name-logic-enable = Включить
signal-port-description-logic-enable = Записывает входной сигнал в ячейку памяти только при ВЫСОКОМ уровне сигнала.

signal-port-name-logic-random-input = Входной сигнал
signal-port-description-logic-random-input = Принимает любой сигнал для генерации случайного результата на выходе.
