...
reagent-desc-aloxadone = Криогенный химикат. Используется для лечения тяжелых ожогов и обморожений путем регенерации пораженных тканей. Работает независимо от того, жив пациент или мертв.

reagent-name-mannitol = маннитол
reagent-desc-mannitol = Эффективно восстанавливает повреждения мозга.

reagent-name-psicodine = психодин
reagent-desc-psicodine = Подавляет тревогу и другие различные формы психического расстройства. Передозировка вызывает галлюцинации и незначительный токсический урон.

reagent-name-potassium-iodide = иодид калия
reagent-desc-potassium-iodide = Снижает разрушительный эффект радиации на 90%. Использовать только в профилактических целях.

reagent-name-haloperidol = галоперидол
reagent-desc-haloperidol = Выводит большинство стимулирующих и галлюциногенных препаратов. Уменьшает наркотические эффекты и дрожь. Вызывает сонливость.

reagent-name-heparin = гепарин
reagent-desc-heparin = Широко используется в качестве антикоагулянта. Препятствует свертыванию крови. Передозировка может вызвать внутреннее кровотечение.
