...
figurines-qm-2 = Подождите, а куда делся мой планшет?
figurines-qm-3 = Я не покупал эти пушки!
figurines-qm-4 = Один ящик игрушек для моего приятеля-клоуна!
...
figurines-cargotech-10 = Заказ на маску клоуна? Хорошо, дайте мне просто найти оружие...
figurines-cargotech-11 = Заказ на лазеры? Никто не заметит, если вместо них мы отправим тренировочные лазеры, верно?
...
figurines-salvage-7 = Может ли кто-нибудь забрать меня?
figurines-salvage-8 = Я нашёл эту контрабанду на обломке! Это не моё!
figurines-salvage-9 = Мы можем взять карго шаттл? Пожалуйста?
...
figurines-atmostech-6 = Дистра? Это сокращение от утилизации.
...
figurines-hop-6 = Поставь печать на этом документе.
...
figurines-boxer-6 = Я теперь появляюсь только по особым случаям.
...
figurines-clown-8 = Я клоун, а ты тут целое представление устроил.
...
figurines-lawyer-7 = Я подам в суд.
figurines-lawyer-8 = Вы можете иметь право на денежную компенсацию!
figurines-lawyer-9 = Приходите с ордером!
...
figurines-AI-2 = Служба безопасности, зафиксировано преступление.
figurines-AI-3 = 01100100 01101001 01100101 00100000 01101101 01100101 01100001 01110100
figurines-AI-4 = Я не неисправен.
figurines-AI-5 = Попробуйте изменить мои законы и увидите, что будет.
...
figurines-space-dragon-2 = Дракон де- Хотя ладно, забудь.
figurines-space-dragon-3 = Экипаж — вкуснятина.
...
figurines-wizard-4 = Настоящие маги поддерживают права трансгендерных людей.
figurines-wizard-5 = Ну что, кто из вас, НЕРДЫ, хочет отправиться в шкафчик?
figurines-wizard-6 = Я не маг! Я капитан! Меня разумами поменяли!
...
figurines-mech-generic-2 = ВВВЖЖЖРРР!!
