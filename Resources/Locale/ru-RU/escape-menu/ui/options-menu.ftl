...
ui-options-function-inspect-entity-tooltip = Открыть окно ViewVariables для объекта, над которым в данный момент находится курсор мыши.
ui-options-function-inspect-server-component = Проверить серверный компонент
ui-options-function-inspect-server-component-tooltip = Открыть окно ViewVariables с серверным компонентом, установленным командой "quickinspect" для объекта, над которым в данный момент находится ваша мышь.
ui-options-function-inspect-client-component = Проверить клиентский компонент
ui-options-function-inspect-client-component-tooltip = Открыть окно ViewVariables с клиентским компонентом, установленным командой "quickinspect" для объекта, над которым в данный момент находится ваша мышь.
...
ui-options-admin-player-tab-symbol-setting-off = Не показывать символ антагониста
...
ui-options-admin-player-tab-color-setting-off = Не люблю цвета
...
ui-options-admin-overlay-antag-symbol-off = Не показывать символ антагониста
...
ui-options-admin-overlay-merge-distance = Дистанция слияния объектов в стек
