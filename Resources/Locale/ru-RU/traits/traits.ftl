...
trait-scottish-desc = Вы говорыте как настоящый шотландец!
...
trait-hemophilia-desc = Ваш организм не способен сворачивать кровь.

trait-impaired-mobility-name = Нарушение подвижности
trait-impaired-mobility-desc = Вам трудно передвигаться без средств помощи.
