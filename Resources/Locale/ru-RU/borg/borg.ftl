...
borg-mind-added = {$name} включается!
borg-mind-removed = {$name} выключается!
...
borg-module-incompatible = Этот модуль не совместим с {$existing}.

borg-module-action-name = Активировать {$moduleName}
borg-module-action-description = Выберите {$moduleName}, чтобы использовать его инструменты.
